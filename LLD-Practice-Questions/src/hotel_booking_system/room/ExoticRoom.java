...
public class ExoticRoom extends Room {

    public ExoticRoom(String roomNo, String description, String moreInformation, BigDecimal pricePerNight, RoomStatus roomStatus, int capacity, List<String> amenities, int floorNumber, BedType bedType) {
        super(roomNo, description, moreInformation, pricePerNight, roomStatus, capacity, amenities, floorNumber, bedType);
    }

    @Override
    public RoomType getRoomType() {
        return RoomType.EXOTIC;
    }
}
