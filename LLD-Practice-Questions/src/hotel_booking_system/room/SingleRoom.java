...
public class SingleRoom extends Room {
    ...
    public SingleRoom(String roomNo, String description, String moreInformation, BigDecimal pricePerNight, RoomStatus roomStatus, int capacity, List<String> amenities, int floorNumber, BedType bedType) {
