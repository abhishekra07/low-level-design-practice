...
public class DeluxeRoom extends Room {
    ...
    public DeluxeRoom(String roomNo, RoomType roomType, String description, String moreInformation, BigDecimal pricePerNight, RoomStatus roomStatus, int capacity, List<String> amenities, int floorNumber, BedType bedType) {
